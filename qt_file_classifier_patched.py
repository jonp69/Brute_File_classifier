...
def print_file_stats():
    ...
    global last_stats_time, file_type_stats
        ...
        for drive in self.drive_paths:
            try:
                for root, dirs, files in os.walk(drive):
                    ...
                    dirs[:] = [d for d in dirs if not any(ex.lower() == d.lower() for ex in full_exclude_dirs) and not d.startswith('.')]
            ...
            try:
                ...
                for root, dirs, files in os.walk(drive):
                    ...
                    for file in files:
                        ...
                        _, ext = os.path.splitext(file.lower())
                          if ext not in full_exclude_extensions and not file.startswith('.'):
                            try:
                                # Update file type statistics
